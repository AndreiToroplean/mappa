...
Two geographies — the 50 US states and the 101 French départements — and two modes: Trial, where three misses ends the run, and Practice, where nothing does and clues are there if you ask. One self-contained HTML file: no network calls, no dependencies at runtime, no ads.
